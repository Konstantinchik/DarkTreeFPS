...
namespace DarkTreeFPS
{
    ...
    public class NPC : MonoBehaviour
    {
        ...
        private float calmDownTimer; // warning CS0649: Field 'NPC.calmDownTimer' is never assigned to, and will always have its default value 0
        ...
        private float m_TurnAmount;         // Field 'NPC.m_TurnAmount' is never assigned to, and will always have its default value 0
        private float m_ForwardAmount;
        private Vector3 m_GroundNormal;
        private float m_CapsuleHeight;      // warning CS0649: Field 'NPC.m_CapsuleHeight' is never assigned to, and will always have its default value 0
        private Vector3 m_CapsuleCenter;    // warning CS0649: Field 'NPC.m_CapsuleCenter' is never assigned to, and will always have its default value 
        private CapsuleCollider m_Capsule;  // warning CS0649: Field 'NPC.m_Capsule' is never assigned to, and will always have its default value null
        ...
        private void Start()
        {
            ...
            playerHealth = Object.FindFirstObjectByType<PlayerStats>();
            ...
            coverList = Object.FindFirstObjectByType<CoverList>();
        ...
        private bool randomTimeGenerated = false; // warning CS0414: The field 'NPC.randomTimeGenerated' is assigned but its value is never used
